...
## Repository Files
- `Fraud_Detection_Accredian.ipynb` → Full notebook solution

## Important Note
The original dataset is very large, so for modeling I used a practical sampled dataset while preserving all fraud cases. This was done to make training efficient while still maintaining meaningful fraud detection performance.

## Author
**Manthan**# Fraud Detection Case Study – Accredian Assignment
